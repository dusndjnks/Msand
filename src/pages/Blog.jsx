...
const Blog = () => {
  return (
    <div className="h-[80vh] flex items-center justify-center bg-accent-2 text-text-base font-sans">
      <motion.div
      ...
      >
        ...
        <p className="text-text-light text-lg mb-6">
          We’re working on exciting content. Check back soon for news, tips, and stories! 🚀
        </p>
        <NavLink
          to="/"
